...
export default class Car {
    ...
    setup() {
        ...
        const chassisShape = new CANNON.Box(new CANNON.Vec3(1.3, 0.7, 2.9));
    ...
    controls() {
        ...
        const brake = () => {    
            this.vehicle.setBrake(brakeForce * 2.5, 0);
            this.vehicle.setBrake(brakeForce * 2.5, 1);
            this.vehicle.setBrake(brakeForce * 2.5, 2);
            this.vehicle.setBrake(brakeForce * 2.5, 3);
        }
